...
Q1: How do the estimates for the common parameters compare?
...
Q2: Which model is better?

>*Answer 2:*

Q3: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?
...
Q4: Is there a preferred model and if so, which one?
...
Q5: Why is it not okay to compare the AIC of these NLS models with the AIC of the MLE models? Hint: type `?AIC` into the R console and do some reading.
